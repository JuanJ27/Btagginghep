...
void graphsTree()
{
    ...
    // Jets por evento
    TH1F *hJetsPerEvent = new TH1F("hJetsPerEvent", "Numero de Jets por Evento", 10, 1, 10);
    
    // pT de los jets
    TH1F *hJetPT[4];
    for (int i = 0; i < 4; i++) {
    hJetPT[i] = new TH1F(Form("hJetPT%d", i), Form("pT del Jet"), 200, 0, 200); // Ajusta los límites según sea necesario
    ...
    for (int i = 0; i < 6; i++)
    {
        hDeltaRPar[i] = new TH1F(Form("hDeltaRPar%d", i), Form("Delta R entre los primeros 4 jets, por parejas"), 100, 0, 9);
        // Asigna un color único a cada histograma
        if (i == 0)
    ...
    for (int i = 0; i < 4; i++) {
        hChargedParticles[i] = new TH1F(Form("hChargedParticles%d", i), Form("Numero de particulas cargadas del Jet"), 50, 0, 25);
    // Asigna un color único a cada histograma
    ...
    for (int i = 0; i < 4; i++) {
        hNeutralsParticles[i] = new TH1F(Form("hNeutralsParticles%d", i), Form("Numero de particulas neutras del Jet"), 50, 0, 25);
    // Asigna un color único a cada histograma
    ...
    for (int i = 0; i < 4; i++) {
    hParticlesBelowAvgPT[i] = new TH1F(Form("hParticlesBelowAvgPT%d", i), Form("Numero de particulas con pT < pT promedio del Jet"), 100, 0, 110);//Cambie el limite superior de 50 a 80
    ...
    for (int i = 0; i < 4; i++) {
    hParticlesAboveAvgPT[i] = new TH1F(Form("hParticlesAboveAvgPT%d", i), Form("Numero de particulas con pT > pT promedio del Jet"), 100, 0, 50);
    ...
    for (int i = 0; i < 4; i++) {
    hPTDifference[i] = new TH1F(Form("hPTDifference%d", i), Form("pT(par_max_pT) - pT(par_min_pT) del Jet"), 200, 0, 200);
    ...
    for (int i = 0; i < 4; i++) {
    hR50PercentPT[i] = new TH1F(Form("hR50PercentPT%d", i), Form("R para 50%% pT total del Jet"), 100, 0, 0.4);
    ...
    for (int i = 0; i < 4; i++) 
    {
        hR95PercentPT[i] = new TH1F(Form("hR95PercentPT%d", i), Form("R para 95%% pT total del Jet"), 100, 0, 0.4);
        // Assign a unique color to each histogram
